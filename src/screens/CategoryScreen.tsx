...
import catalogService, {Category, Banner} from '../services/catalogService';
...
const OrdersIcon = () => (
  <Svg width={scale(25)} height={scale(25)} viewBox="0 0 25 25" fill="none">
    <G clipPath="url(#clip_orders_cat)">
      <Mask id="mask_orders_cat" maskUnits="userSpaceOnUse" x={-1} y={0} width={25} height={25}>
        <Path d="M-0.010498 0.500002H23.9895V24.5H-0.010498V0.500002Z" fill={COLORS.backgroundWhite} />
      </Mask>
      <G mask="url(#mask_orders_cat)">
    ...
    <Defs>
      <ClipPath id="clip_orders_cat"><Rect width={25} height={25} fill={COLORS.backgroundWhite} /></ClipPath>
    </Defs>
  </Svg>
);
...
const NavCartIcon = () => (
  <Svg width={scale(24)} height={scale(24)} viewBox="0 0 24 24" fill="none">
    ...
    <Defs>
      <ClipPath id="clip_cart_cat"><Rect width={24} height={24} fill={COLORS.backgroundWhite} /></ClipPath>
    </Defs>
  </Svg>
);
...
const ShopIcon = () => (
  <Svg width={scale(24)} height={scale(24)} viewBox="0 0 24 24" fill="none">
    <Path d="M3.01 11.22V15.71C3.01 20.2 4.81 22 9.3 22H14.69C19.18 22 20.98 20.2 20.98 15.71V11.22" stroke={COLORS.textWhite} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M12 12C13.83 12 15.18 10.51 15 8.68L14.34 2H9.67L9 8.68C8.82 10.51 10.17 12 12 12Z" stroke={COLORS.textWhite} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M18.31 12C20.33 12 21.81 10.36 21.61 8.35L21.33 5.6C20.97 3 19.97 2 17.35 2H14.3L15 9.01C15.17 10.66 16.66 12 18.31 12Z" stroke={COLORS.textWhite} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M5.64 12C7.29 12 8.78 10.66 8.94 9.01L9.16 6.8L9.64 2H6.59C3.97 2 2.97 3 2.61 5.6L2.34 8.35C2.14 10.36 3.62 12 5.64 12Z" stroke={COLORS.textWhite} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M12 17C10.33 17 9.5 17.83 9.5 19.5V22H14.5V19.5C14.5 17.83 13.67 17 12 17Z" stroke={COLORS.textWhite} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

const CategoryScreen: React.FC<{navigation?: any}> = ({navigation}) => {
  const categoryItemWidth = (SCREEN_WIDTH - scale(44)) / 3;
  ...
  // Fall back to a single hardcoded slide when no banners are configured.
  const bannerCount = hasDynamicBanners ? banners.length : 1;
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Editable bulk-quote banner text — isolated so a failure here never
        // breaks the main load (mirrors HomeScreen).
        catalogService
          .getAppSettings()
          .then(settingsRes => {
  ...
  // Auto-scroll banner (only meaningful with more than one slide)
  useEffect(() => {
    ...
    <View style={{flex: 1, backgroundColor: COLORS.background}}>
      ...
      <ScrollView
        ...
        <View style={{position: 'relative'}}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      banner.enableBulkQuote
                        ? navigation?.navigate('GetQuotation', {isLoggedIn: true})
                        : banner.link
          ...
          {/* Search button overlay - top right */}
          <TouchableOpacity
            style={{
              position: 'absolute',
              right: scale(16),
          ...
          <View
            ...
            {categories.map(cat => (
              <TouchableOpacity
                ...
                <View
                  style={{
                    width: categoryItemWidth - scale(4),
                    height: scale(100),
                  ...
                  <Image
                    source={cat.image ? {uri: cat.image} : require('../assets/images/shop-cement.png')}
